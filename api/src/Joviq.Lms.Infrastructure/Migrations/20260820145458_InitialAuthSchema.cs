        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStatus = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    OnboardingStatus = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CgpaOrPercentage = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    TargetJobRole = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DestinationType = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_otps_Destination_Purpose_ConsumedAt",
                table: "user_otps",
                columns: new[] { "Destination", "Purpose", "ConsumedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_sessions_RefreshTokenFamilyId",
                table: "user_sessions",
