...
import { ArrowRight, Award, BarChart3, BookOpen, BriefcaseBusiness, CheckCheck, ClipboardCheck, Code2, FileSearch, FileText, GraduationCap, Lightbulb, MessageCircle, PhoneCall, PlayCircle, Rocket, ShieldCheck, Target, Trophy, UsersRound, Video, X } from "lucide-react";
  ...
  return <div className="site-page features-page"><PublicNavbar /><main>
    <section className="ft-hero">
      <div className="ft-hero-copy"><span className="ft-eyebrow">FEATURES</span><h1>Learn Better.<br />Build Skills.<br />Get <span>Career Ready.</span></h1><p>Powerful learning features designed to give you real skills, hands-on experience, and the right support at every step of your journey.</p>
        <div className="ft-actions"><Link className="ft-button" to="/programs">Explore Programs <ArrowRight size={18} /></Link><a className="ft-button ft-outline" href="#learning-features"><BookOpen size={20} /> Discover Features</a></div>
      ...
      <div className="ft-art"><img src="/assets/programs/programs-student.png" alt="Smiling learner holding a laptop" /><span className="ft-handwriting">Skills today,<br />better tomorrows</span><div className="ft-float ft-learn"><BarChart3 /><span><b>Learn</b><br />Practice<br />Grow<br />Succeed</span></div><div className="ft-float ft-guidance"><Lightbulb /><b>Expert<br />Guidance<br />Always</b></div><div className="ft-float ft-projects"><UsersRound /><b>Real Projects<br />Real Skills</b></div><div className="ft-float ft-career"><Trophy /><b>Career<br />Ready You</b></div></div>
    </section>
    <section className="ft-features" id="learning-features"><header><span className="ft-eyebrow">JOVIQ LEARNING FEATURES</span><h2>Everything You Need in One Place</h2><p>Explore our powerful features designed to help you learn, practice, build, and grow with real-world support.</p></header>
      <div className="ft-grid">{features.map(feature => <button className="ft-card" key={feature.title} onClick={() => setSelected(feature)} aria-haspopup="dialog"><span className={`ft-icon ${feature.color}`}><feature.icon /></span><span className="ft-card-copy"><strong>{feature.title}</strong><span>{feature.text}</span></span><span className="ft-card-arrow"><ArrowRight size={16} /></span></button>)}<Link className="ft-card ft-future" to="/programs"><Rocket /><strong>Your<br />Future is Closer<br />with Joviq</strong><span className="ft-card-arrow"><ArrowRight size={16} /></span></Link></div>
      <section className="ft-cta"><div><span className="ft-eyebrow">READY TO TAKE THE NEXT STEP?</span><h2>Start Your Learning Journey with <span>Joviq</span></h2><p>Get access to learning features, expert guidance, and real-world opportunities.</p><div className="ft-actions"><Link className="ft-button" to="/programs">Explore Programs <ArrowRight size={18} /></Link><Link className="ft-button ft-outline" to="/request-callback"><PhoneCall size={18} /> Request Callback</Link></div></div><div className="ft-cta-note"><Rocket /><span>Learn.<br />Build.<br />Grow.</span></div><div className="ft-checklist">{["New Skills", "Real Projects", "New Opportunities", "A Brighter You"].map(text => <span key={text}><CheckCheck size={16} />{text}</span>)}</div></section>
    </section>
