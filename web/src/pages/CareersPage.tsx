...
const categories = ["All teams", "Student Experience", "Learning & Content", "Campus & Community"];
const values = [
...
export function CareersPage() {
  ...
  const visibleRoles = roles.filter(role => category === "All teams" || role.category === category);
