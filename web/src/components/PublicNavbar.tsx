...
import { ChevronDown, ExternalLink, Menu, Sparkles, X } from "lucide-react";
...
export function PublicNavbar() {
  ...
  return (
    <header
      className={`site-nav ${isMenuOpen ? "is-open" : ""} ${isProgramsMegaOpen ? "has-mega-open" : ""}`}
      onMouseLeave={() => setIsProgramsMegaOpen(false)}
    >
      <Link className="site-nav__brand" to="/" onClick={closeMenus} aria-label="Joviq Technologies home">
